...
export default function Home() {
  ...
  function importHealth() {
    ...
    else notify('请在 Android App 中选择 Gadgetbridge 自动导出的数据库。');
  }
